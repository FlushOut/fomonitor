...
--
-- Servidor: localhost
-- Tiempo de generación: 14-04-2014 a las 11:21:16
...
--
CREATE DATABASE IF NOT EXISTS `dbmonitor` DEFAULT CHARACTER SET utf8 COLLATE utf8_spanish_ci;
USE `dbmonitor`;
...
INSERT INTO `categories` (`id`, `id_company`, `description`, `status`) VALUES
(1, 1, 'Funcionales', 1),
(2, 1, 'Personales', 1);
...
INSERT INTO `modules` (`id`, `fk_description`, `parent`, `class`, `tab`, `status`) VALUES
(1, 1, NULL, 'icon-align-justify', NULL, 1);
